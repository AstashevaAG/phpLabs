    ...
    <form class="form" action="https://httpbin.org/post" method="post">
        ...
        <div class="form-parts">
            <div>
                ...
                <legend class="form__label">Способ обратной связи</legend>
                <div class="input">
                    <input type="checkbox" id="sms" name="sms" checked>
                    <label class="label" class="form__label" for="name">SMS на телефон</label>
                </div>
                <div class="input">
                    <input type="checkbox" id="email" name="email">
                    <label class="label" for="name">Сообщение на почту</label>
                </div>
            </div>
